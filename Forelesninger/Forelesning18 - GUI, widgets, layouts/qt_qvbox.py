...
# Denne klassen er tenkt å inneholde all kode for å lage GUI-et som skal vises for vinduet vårt.
class Hovedvindu(QWidget):
    def __init__(self):
        super().__init__()

        self.setWindowTitle('QVBoxLayout-test')     # Gir vinduet en tittel
        #self.setGeometry(200, 50, 120, 100)       # Gir vinduet en selvdefinert størrelse, 200x50, samt avstand fra venstre kant av skjermen, 120, og fra toppen, 100.
        ...
        layout.addWidget(button1)                   # Legger til button1 i layout (vil bli vist på toppen siden den legges til først)
        layout.addWidget(button3)                   # Legger til button3 i layout (vil bli vist under button1, jmf. append()-metoden vi har sett på tidligere)
        #layout.addStretch()                        # Vi kan legge til en stretch, dersom vi ønsker å flytte knapper opp eller ned i vinduet. Hvor i koden vi legger til denne vil påvirke sluttresultatet. Legger vi den til her vil elementer vi allerede har lagt til bli presset til toppen av vinduet, mens elementer vi legger til etter vil bli presset til bunnen.
        ...
        layout.setSpacing(10)                       # Vi kan bestemme avstanden mellom knappene ved å legge til spacing
