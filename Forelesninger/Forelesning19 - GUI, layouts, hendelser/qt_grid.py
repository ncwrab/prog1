...
class Hovedvindu(QWidget):
    def __init__(self):
        ...
        layout.addWidget(min_beskjed, 2,1)               # Legger til boksen i layoutet, med koordinatene 2,1
        ...
        layout.addWidget(min_slider, 2,2)                # Legger den til i layoutet, med koordinatene 2,2
