...
class Hovedvindu(QWidget):
    def __init__(self):
        ...
        self.meny_combobox.activated.connect(self.oppdater_bilde)   # Legger til en hendelse og kobler den til en funksjon/metode. Hver gang bruker velger i lista skal funksjonen oppdater.bilde() kalles.
