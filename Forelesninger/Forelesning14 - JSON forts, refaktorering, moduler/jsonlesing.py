...
# Oppretter en json-string med noen key:value-par. Bruker ''' ''' for å få en kommentar til å strekke seg over flere linjer (kun for vår lesbarhet, vi kunne fint hatt alt på samme linje).
...
'''
# Skriver ut innholdet av variabelen
print(json_string)
